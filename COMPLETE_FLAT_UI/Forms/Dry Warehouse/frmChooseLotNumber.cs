...
namespace ULTRAMAVERICK.Forms.Dry_Warehouse
{
    public partial class frmChooseLotNumber : MaterialForm
    {
        ...
        {
            if (MetroFramework.MetroMessageBox.Show(this, "Are you sure that you want to select the lot area?", "Information", MessageBoxButtons.YesNo, MessageBoxIcon.Information) == DialogResult.Yes)
            {
                mode = "true";
                this.Close();
            }
