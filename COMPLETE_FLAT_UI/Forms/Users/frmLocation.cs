...
namespace ULTRAMAVERICK.Forms.Users
{
    public partial class frmLocation : MaterialForm
    {
        ...
        private void txtmatLocation_KeyPress(object sender, KeyPressEventArgs e)
        {
            e.KeyChar = Char.ToUpper(e.KeyChar);
        }

        private void dgvLocation_CellFormatting(object sender, DataGridViewCellFormattingEventArgs e)
        {
