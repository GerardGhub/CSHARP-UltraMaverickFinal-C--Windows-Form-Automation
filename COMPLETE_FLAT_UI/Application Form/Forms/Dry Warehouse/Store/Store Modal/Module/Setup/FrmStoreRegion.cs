    ...
    public partial class frmRegion : MaterialForm
    {
        ...
        private void PutInactiveData()
        {
            if (this.matRadioActive.Checked == true)
            {
                ...
                if (MetroFramework.MetroMessageBox.Show(this, "Are you sure that you want to deactivate the data?", "Warning", MessageBoxButtons.YesNo, MessageBoxIcon.Warning) == DialogResult.Yes)
                {
            ...
            {
                //
                if (MetroFramework.MetroMessageBox.Show(this, "Are you sure that you want to activate?", "Warning", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
                {
                    if (Convert.ToInt32(this.lbltotalrecords.Text) > 0)
                    {
                        this.dSet.Clear();
